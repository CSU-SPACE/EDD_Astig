...
class BottomupPoseEstimator(BasePoseEstimator):
    ...
    def predict(
        self, inputs: Union[Tensor, List[Tensor]], data_samples: SampleList
    ) -> SampleList:
    ...
    def add_pred_to_datasample(
        ...
        for pred_instances, pred_fields, data_sample in zip_longest(
            ...
            pred_instances.keypoints = (
                pred_instances.keypoints / input_size * input_scale
                + input_center
                - 0.5 * input_scale
            )
            ...
            if "bboxes" in pred_instances:
                ...
                bboxes = (
                    bboxes / input_size * input_scale + input_center - 0.5 * input_scale
                )

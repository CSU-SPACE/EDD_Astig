...
class PixelWiseDotProduct(nn.Module):
    ...
    def forward(self, x, K):
        ...
        _, cout, ck = K.size()
        assert c == ck, (
            "Number of channels in x and Embedding dimension "
...
class AdabinsHead(nn.Module):
    ...
    def __init__(
        ...
        self.conv3x3 = build_conv_layer(
            conv_cfg, in_channels, embedding_dim, kernel_size=3, stride=1, padding=1
        )
    ...
    def predict(
        self, inputs: Tuple[Tensor], batch_img_metas: List[dict], test_cfg, **kwargs
    ) -> Tensor:

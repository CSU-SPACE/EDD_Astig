_base_ = (
    "./catseg_vitb-r101_4xb2-warmcoslr2e-4-adamw-80k_coco-stuff164k-384x384.py"  # noqa
)
...
param_scheduler = [
    ...
    dict(type="CosineAnnealingLR", T_max=79500, by_epoch=False, begin=500, end=80000),
]

...
if __name__ == "__main__":
    ...
    train_imgs = glob.glob(
        "data/ISBI2016_ISIC_Part1_Training_Data/*" + img_suffix  # noqa
    )
    train_masks = glob.glob(
        "data/ISBI2016_ISIC_Part1_Training_GroundTruth/*" + seg_map_suffix  # noqa
    )

    test_imgs = glob.glob("data/ISBI2016_ISIC_Part1_Test_Data/*" + img_suffix)
    test_masks = glob.glob(
        "data/ISBI2016_ISIC_Part1_Test_GroundTruth/*" + seg_map_suffix  # noqa
    )

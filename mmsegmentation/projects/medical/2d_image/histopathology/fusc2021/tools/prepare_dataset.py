...
src_img_train_dir = os.path.join(
    root_path,
    "wound-segmentation/data/" + "Foot Ulcer Segmentation Challenge/train/images",
)
src_img_val_dir = os.path.join(
    root_path,
    "wound-segmentation/data/" + "Foot Ulcer Segmentation Challenge/validation/images",
)
src_img_test_dir = os.path.join(
    root_path,
    "wound-segmentation/data/" + "Foot Ulcer Segmentation Challenge/test/images",
)
src_mask_train_dir = os.path.join(
    root_path,
    "wound-segmentation/data/" + "Foot Ulcer Segmentation Challenge/train/labels",
)
src_mask_val_dir = os.path.join(
    root_path,
    "wound-segmentation/data/" + "Foot Ulcer Segmentation Challenge/validation/labels",
)
...
def convert_label_pics_into_pngs(src_dir, tgt_dir, suffix, convert_dict={0: 0, 255: 1}):
    if not os.path.exists(tgt_dir):
        os.makedirs(tgt_dir)

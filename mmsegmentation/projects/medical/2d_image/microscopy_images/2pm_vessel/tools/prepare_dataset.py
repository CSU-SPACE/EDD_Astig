...
image_dir = os.path.join(root_path, "2-PM_Vessel_Dataset/raw/vesselNN_dataset/denoised")
label_dir = os.path.join(root_path, "2-PM_Vessel_Dataset/raw/vesselNN_dataset/labels")

...
def parse_args():
    parser = argparse.ArgumentParser(description="PP_Mobileseg ONNX inference demo.")
    parser.add_argument("onnx_file", help="ONNX file path")
    parser.add_argument("image_file", help="Input image file path")
    parser.add_argument(
        "--input-size", type=int, nargs="+", default=[512, 512], help="input image size"
    )
...
def postprocess(outputs: List[np.ndarray], origin_shape: Tuple[int, int]) -> np.ndarray:

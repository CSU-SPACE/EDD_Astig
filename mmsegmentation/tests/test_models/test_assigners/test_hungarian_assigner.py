...
class TestHungarianAssigner(TestCase):
    ...
    def test_hungarian_match_assigner(self):
        ...
        matched_quiery_inds, matched_label_inds = assigner.assign(
        ...
        self.assertTrue(torch.equal(unique_label_inds, torch.arange(0, num_classes)))
    ...
    def test_mask_match_cost(self):
        ...
        # test DiceCost
        assigner = HungarianAssigner(dict(type="DiceCost", pred_act=True, eps=1.0))
